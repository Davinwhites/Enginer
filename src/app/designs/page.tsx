        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 pt-32 pb-24">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="mb-16">
                        <h1 className="text-4xl md:text-6xl font-bold mb-6">New Designs</h1>
                        <p className="text-gray-400 text-lg max-w-2xl">
                            Architectural concepts and structural designs that push the boundaries of modern engineering aesthetics.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {designs.length > 0 ? (
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-gray-950/90 via-gray-950/20 to-transparent flex flex-col justify-end p-8">
                                        <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                                            <div className="flex items-center gap-2 text-emerald-400 mb-3">
                                                ...
                                                <span className="text-[10px] font-black uppercase tracking-widest">Architectural Concept</span>
                                            </div>
                            ...
                            <div className="col-span-full py-20 text-center bg-gray-900/50 rounded-3xl border border-dashed border-gray-800">
                                <p className="text-gray-500">New designs collection is coming soon.</p>
                            </div>
                        )}
                    </div>
                </div>
