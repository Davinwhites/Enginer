    ...
    return (
        <footer className="bg-gray-950 border-t border-gray-900 pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <div className="space-y-4">
                    <Link href="/" className="flex items-center gap-2 group">
                        <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-emerald-600 rounded flex items-center justify-center font-black text-white">E</div>
                        <span className="text-lg font-bold tracking-tight text-white uppercase">Engineer<span className="text-emerald-500">.</span></span>
                    </Link>
                    <p className="text-gray-500 text-sm leading-relaxed">
                        Leading engineering solutions with a focus on precision, innovation, and sustainable design practices.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm text-gray-400">
                        ...
                        <li><Link href="/contact" className="hover:text-blue-400 transition-colors">Get Quotation</Link></li>
            ...
            <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-gray-900 flex flex-col md:row justify-between items-center gap-4 text-xs text-gray-500">
                <p>© {new Date().getFullYear()} Professional Engineer Office. All rights reserved.</p>
